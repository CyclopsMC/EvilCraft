        ...
        for(IModCompat modCompat : MODCOMPATS) {
            if(shouldLoadModCompat(modCompat)) {
                try {
                    ...
                    EvilCraft.clog("The EvilCraft mod compatibility for " + modCompat.getModID() +
                            " has crashed! Report this crash clog to the mod author or try updating the conflicting mods.", Level.ERROR);
