...
public class SanguinaryPedestalBlockReplacePacket extends PacketCodec<SanguinaryPedestalBlockReplacePacket> {
    ...
    public static final Type<SanguinaryPedestalBlockReplacePacket> ID = new Type<>(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "sanguinary_pedestal_block_replace"));
