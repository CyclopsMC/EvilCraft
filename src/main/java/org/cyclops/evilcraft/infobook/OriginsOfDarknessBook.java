...
public class OriginsOfDarknessBook extends InfoBook {
    ...
    static {
        ...
        if(Configs.isEnabled(BloodInfuserConfig.class)) {
            InfoBookParser.registerFactory(Reference.MOD_ID + ":bloodInfuserRecipe", new InfoBookParser.IAppendixItemFactory<ItemFluidStackAndTierRecipeComponent, ItemStackRecipeComponent, DurationXpRecipeProperties>() {
        ...
        if(Configs.isEnabled(EnvironmentalAccumulatorConfig.class)) {
            InfoBookParser.registerFactory(Reference.MOD_ID + ":envirAccRecipe", new InfoBookParser.IAppendixItemFactory<EnvironmentalAccumulatorRecipeComponent, EnvironmentalAccumulatorRecipeComponent, EnvironmentalAccumulatorRecipeProperties>() {
