...
public class RecipeSerializerEnvironmentalAccumulatorBiomeExtract extends RecipeSerializerEnvironmentalAccumulatorAbstract<RecipeEnvironmentalAccumulatorBiomeExtract> {
    @Override
    protected RecipeEnvironmentalAccumulatorBiomeExtract createRecipe(Ingredient inputIngredient, WeatherType inputWeather, Either<ItemStackTemplate, ItemStackFromIngredient> outputItem, WeatherType outputWeather, Optional<Integer> duration, Optional<Integer> cooldownTime, Optional<Float> processingSpeed) {
