 ...
 * @author rubensworks
 */
public class RecipeSerializerEnvironmentalAccumulator extends ForgeRegistryEntry<IRecipeSerializer<?>>
        implements IRecipeSerializer<RecipeEnvironmentalAccumulator> {
    ...
    @Override
    public RecipeEnvironmentalAccumulator read(ResourceLocation recipeId, JsonObject json) {
        ...
        return new RecipeEnvironmentalAccumulator(recipeId, inputIngredient, inputWeather, outputItemStack, outputWeather, duration, cooldownTime, processingSpeed);
    }

    @Nullable
    @Override
    public RecipeEnvironmentalAccumulator read(ResourceLocation recipeId, PacketBuffer buffer) {
        // Input
