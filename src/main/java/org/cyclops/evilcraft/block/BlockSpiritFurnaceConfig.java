...
public class BlockSpiritFurnaceConfig extends UpgradableBlockContainerConfig {
    ...
    @ConfigurablePropertyCommon(category = "machine", comment = "How much mB per tick this furnace should consume.")
    public static int mBPerTick = 25;

    @ConfigurablePropertyCommon(category = "machine", comment = "How much mB per tick this furnace should consume for player spirit.")
    public static int playerMBPerTick = mBPerTick * 4;

    @ConfigurablePropertyCommon(category = "machine", comment = "How much mB per tick this furnace should consume for boss mob spirit.")
    public static int bossMBPerTick = mBPerTick * 10;

    @ConfigurablePropertyCommon(category = "machine", comment = "The required amount of ticks for each HP for cooking an entity.")
    public static int requiredTicksPerHp = 10;

    @ConfigurablePropertyCommon(category = "machine", comment = "If the machine should play mob death sounds.")
    public static boolean mobDeathSounds = true;

    @ConfigurablePropertyCommon(category = "machine", comment = "The 1/X chance for villagers to drop emeralds. 0 means no drops.")
    public static int villagerDropEmeraldChance = 20;

    @ConfigurablePropertyCommon(category = "machine",
