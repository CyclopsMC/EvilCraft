...
public class Thaumcraft {
    ...
    public static void register() {
        ...
        if(Configs.isEnabled(BloodWandCapConfig.class)) {
            WandCap bloodWandCap = new WandCap("blood", 0.95F, 1, new ItemStack(BloodWandCapConfig._instance.getItemInstance()), 3, new ResourceLocation(Reference.MOD_ID, Reference.TEXTURE_PATH_MODELS + "wand_cap_blood.png")) {
    ...
    private static void registerAspects() {
        ...
        registerEntityTagSafe(WerewolfConfig._instance, new AspectList().add(Aspect.DESIRE, 4).add(Aspect.BEAST, 4), new ThaumcraftApi.EntityTagsNBT[0]);
        ...
        // Poison
        registerObjectTagSafe(FluidBlockPoisonConfig._instance, new AspectList().add(Aspect.DEATH, 4));
        registerObjectTagSafe(BucketPoisonConfig._instance, new AspectList().add(Aspect.DEATH, 4).add(Aspect.METAL, 3));
        registerObjectTagSafe(PoisonSacConfig._instance, new AspectList().add(Aspect.DEATH, 4));

        // Undead tree
        registerObjectTagSafe(UndeadSaplingConfig._instance, new AspectList().add(Aspect.PLANT, 1).add(Aspect.PLANT, 2).add(Aspect.UNDEAD, 2));
        registerObjectTagSafe(UndeadPlankConfig._instance, new AspectList().add(Aspect.PLANT, 1).add(Aspect.UNDEAD, 1));
        registerObjectTagSafe(UndeadLogConfig._instance, new AspectList().add(Aspect.PLANT, 4).add(Aspect.UNDEAD, 4));
        registerObjectTagSafe(UndeadLeavesConfig._instance, new AspectList().add(Aspect.PLANT, 1).add(Aspect.UNDEAD, 1));

        // Werewolf drops
        registerObjectTagSafe(WerewolfBoneConfig._instance, new AspectList().add(Aspect.BEAST, 2).add(Aspect.DEATH, 2));
        ...
        registerObjectTagSafe(WeatherContainerConfig._instance, new AspectList().add(weatherContainerList.copy())/*.add(Aspect.WEATHER, 4)*/.add(Aspect.ELDRITCH, 2));
        ...
        // Other
        registerObjectTagSafe(EnvironmentalAccumulatorConfig._instance, new AspectList().add(Aspect.DARKNESS, 10).add(Aspect.ENTROPY, 5).add(Aspect.EXCHANGE, 4).add(Aspect.MECHANISM, 3)/*.add(Aspect.WEATHER, 10)*/);
        registerObjectTagSafe(SpiritPortalConfig._instance, new AspectList().add(Aspect.DARKNESS, 10).add(Aspect.MOTION, 10).add(Aspect.UNDEAD, 10));
        ...
        registerObjectTagSafe(CorruptedTearConfig._instance, new AspectList().add(Aspect.DEATH, 4).add(Aspect.SOUL, 4).add(Aspect.ENTROPY, 4).add(Aspect.EXCHANGE, 8).add(Aspect.MOTION, 2).add(Aspect.ELDRITCH, 4));
        for(int i = 0; i < 3; i++) {
        ...
        registerObjectTagSafe(EnderTearConfig._instance, new AspectList().add(Aspect.MOTION, 8).add(Aspect.ELDRITCH, 4));
        ...
        registerObjectTagSafe(PotentiaSphereConfig._instance, new AspectList().add(Aspect.CRYSTAL, 2).add(Aspect.LIGHT, 2).add(Aspect.MECHANISM, 1));
