...
public class BloodContainerConfig extends ItemConfig {
     ...
     */
    @ConfigurableProperty(category = ConfigurableTypeCategory.GENERAL, comment = "The base amount of blood (mB) this container can hold * the level of container.", requiresMcRestart = true)
